...
TEST_F(
    LabelsGeneric,
    platypus_duckbill_duckbilled_platypus_duck_billed_platypus_Ornithorhynchus_anatinus) {
...
TEST_F(
    LabelsGeneric,
    king_crab_Alaska_crab_Alaskan_king_crab_Alaska_king_crab_Paralithodes_camtschatica) {
...
TEST_F(
    LabelsGeneric,
    American_Staffordshire_terrier_Staffordshire_terrier_American_pit_bull_terrier_pit_bull_terrier) {
...
TEST_F(
    LabelsGeneric,
    dragonfly_darning_needle_devil_s_darning_needle_sewing_needle_snake_feeder_snake_doctor_mosquito_hawk_skeeter_hawk) {
...
TEST_F(
    LabelsGeneric,
    bighorn_bighorn_sheep_cimarron_Rocky_Mountain_bighorn_Rocky_Mountain_sheep_Ovis_canadensis) {
...
TEST_F(
    LabelsGeneric,
    cash_machine_cash_dispenser_automated_teller_machine_automatic_teller_machine_automated_teller_automatic_teller_ATM) {
...
TEST_F(
    LabelsGeneric,
    yellow_lady_s_slipper_yellow_lady_slipper_Cypripedium_calceolus_Cypripedium_parviflorum) {
