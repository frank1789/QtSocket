/****************************************************************************
** Meta object code from reading C++ file 'udpreceiver.hpp'
**
...
#error "The header file 'udpreceiver.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(4, 31, 11) // "dataPending"

    },
    "UdpReceiver\0updateImage\0\0image\0"
    "dataPending"
};
...
void UdpReceiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->dataPending(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (UdpReceiver::*)(QImage );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UdpReceiver::updateImage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void UdpReceiver::updateImage(QImage _t1)
{
